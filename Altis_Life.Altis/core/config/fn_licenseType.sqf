...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "jreb": {_var = "license_civ_jreb"}; //Rebel License
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_jreb": {_var = "jreb"}; //Rebel License
			case "license_civ_advrebel": {_var = "advrebel"}; // adv rebel
			case "license_civ_bountyh": {_var = "bountyh"}; // bounty hunters
			default {_var = ""};
		};
	};
};
